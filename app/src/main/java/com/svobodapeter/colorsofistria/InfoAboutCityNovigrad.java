...
public class InfoAboutCityNovigrad extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cityPager.setBackgroundColor(getResources().getColor(R.color.background_green));
        ...
        tabLayout.setTabTextColors(getResources().getColor(R.color.white), getResources().getColor(R.color.background_green));

        //Will change in info_about_city.xml header image
        ImageView cityHeader = findViewById(R.id.city_header_image);
        cityHeader.setImageResource(R.drawable.novigrad);
